...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rxn_rebuild-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14200&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rxn_rebuild-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rxn_rebuild` can be installed with:

```
conda install rxn_rebuild
```

It is possible to list all of the versions of `rxn_rebuild` available on your platform with:
